...
int Master::Run()
{
    ...
    sLog->outString("  ____                 _        ____                ");
    sLog->outString(" |  _ \\ __ _ _ __   __| | __ _ / ___| ___  _ __ ___ ");
    sLog->outString(" | |_) / _\` | '_ \\ / _\` |/ _\` | |    / _ \\| '__/ _ \\");
    sLog->outString(" |  __/ (_| | | | | (_| | (_| | |___| (_) | | |  __/");
    sLog->outString(" |_|   \\__,_|_| |_|\\__,_|\\__,_|\\____|\\___/|_|  \\___|");
    sLog->outString("http:/PandariaProject.org						   \n");
